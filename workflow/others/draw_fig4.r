...
#' @LastEditTime: 2024-02-22 11:49:21
    ...
    } %>%
    {
      ...
      pheatmap::pheatmap(
        ...
        color = colorRampPalette(c(
          "seashell", "khaki", "orange", "red", "red3",
          "red4", "purple4", "purple3", "purple2", "purple1"
        ))(100),
        # main = fun.aggregate,
        cellwidth = 10,
        cellheight = 10,
